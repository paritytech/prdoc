...
use clap::{crate_authors, crate_version, Args, ColorChoice, Parser, Subcommand, ValueHint};
...
pub struct Opts {
	...
	#[clap(short = 'd', alias = "dir", long, global = true,
		env = config::env::PRDOC_FOLDERS, value_hint = ValueHint::DirPath)]
	...
	#[arg(short, long = "generate-completions", value_enum)]
...
pub struct GenOpts {
	/// Change number
	#[clap(index = 1, value_hint = ValueHint::Other)]
	pub number: PRNumber,
...
pub struct CheckOpts {
	...
	#[clap(short, long, value_hint = ValueHint::FilePath, conflicts_with = "number")]
	...
	#[clap(short, long,  value_hint = ValueHint::FilePath, conflicts_with_all = ["file", "number"])]
...
pub struct LoadOpts {
	...
	/// Get the list of PR numbers from a file
	#[clap(short, long, conflicts_with_all = ["file", "number"], value_hint = ValueHint::FilePath)]
	pub list: Option<PathBuf>,
}
